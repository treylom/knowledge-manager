...
".venvs\paddleocr-vl\Scripts\pip.exe" install --upgrade git+https://github.com/huggingface/transformers.git
```
...
**Windows 경로 예시:**
```bash
".venvs\paddleocr-vl\Scripts\python.exe" "test_glm_ocr.py"
```
