...
|---|---|---|
| 구조 (상한 40) | MOC 공유 | 15 |
| 구조 (상한 40) | 위키링크 역추적 (후보→대상 또는 대상→후보 기존 링크) | 15 |
| 구조 (상한 40) | 같은 폴더 / 같은 상위 폴더 | 10 / 5 |
| 내용 (상한 45) | 제목·별칭 일치 (정확 / 제목 안 / 본문 안) | 20 / 17 / 11 |
| 내용 (상한 45) | 본문 공출현 (자카드 × 15) | 15 |
| 내용 (상한 45) | 태그 자카드 | 10 |
| 의미 (상한 25) | 어댑터 코사인 × 25 | 25 |
| 의미 (상한 25) | 그래프 관계 엣지 | +10 |
| 최신성 | 동점 타이브레이커 (정렬 전용 · 점수 아님) | ±2 |
| 등급 | 인라인 ≥60 (상한 5) · 관련 40~59 (상한 7) · frontmatter 25~39 · 로그 <25 | — |
